  ...
  return (
    <main className="geometryLab">
      ...
      <style jsx global>{`
        ...
        .hybridConstruction { animation:constructionExit 2.4s var(--alpha-flow) 7.45s forwards; }
        .hybridSketch { animation:sketchSettle 1.25s var(--alpha-flow) 7.3s forwards; }
        ...
        .hybridOutlineGeometry .studyBeam { animation:lineDraw 2s var(--alpha-flow) 5.4s forwards; }
        .hybridFinalGeometry { opacity:0; transform-box:fill-box; transform-origin:center; animation:finalLogoReveal 2.4s var(--alpha-flow) 7.45s forwards,fixedLogoSettle 1.4s var(--alpha-flow) 8.45s both; }
